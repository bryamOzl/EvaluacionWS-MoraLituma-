...
a persistence unit "pruebaSegundoPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "pruebaSegundo\pom.xml":
...
artifact ("pruebaSegundo.war") is already built. You can build
